"""SQLAlchemy ORM model for processed resources — single flat table with JSONB columns."""
...
class ResourceModel(Base):
    """A resource that has been uploaded and processed through the pipeline.

    All classification results, extracted metadata, and summary are stored
    inline using PostgreSQL JSONB columns — one row per resource.
    """
