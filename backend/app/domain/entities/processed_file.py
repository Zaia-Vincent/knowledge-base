"""Domain entities for processed files — classification and metadata extraction results."""
...
class ProcessingStatus(str, Enum):
    """Lifecycle states of a file in the processing pipeline."""
...
@dataclass
class ProcessedFile:
    """Core domain entity: a file that has been uploaded and processed.
